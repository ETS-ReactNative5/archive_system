...
class MainInfoCaseForm extends Component {
  ...
  render() {
    ...
    const {
      ...
      caseStorageOptions, rackOptions, shelfOptions,
      tofiConstants: {fundNumber, caseDbeg,propTimeLife,caseInsurance,caseInsuranceTrue,propAuthenticity, caseDend, caseNumberOfPages, caseStructuralSubdivision, caseOCD,
        caseOCDTrue, fundIndex, caseNotes, numberOfOriginals, caseStorage, rack, shelf,
