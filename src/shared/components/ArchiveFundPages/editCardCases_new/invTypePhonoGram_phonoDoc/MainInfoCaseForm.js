    ...
    const {
      ...
      tofiConstants: {
        ...
        caseDocsLang,
          ...
          rack,
          caseStorage,
          mainContent,manufacturePlace,manufactureDate, initialsOfAuthors,initialsOfTranslators,artistOfTheWork,firstLine,dateEvent,eventLocation,genre
         ...
         {rack && (
          ...
          {mainContent && (
              <Field
                  ...
                  parse={value => { this.mainContent[lang.formatAndBase] = value; return {...this.mainContentValue} }}
          ...
          {genre && (
              <Field
                  name="genre"
                  component={renderInputLang}
                  format={value => (!!value ? value[lang.genre] : '')}
                  parse={value => { this.genre[lang.genre] = value; return {...this.genreValue} }}
          ...
          {eventLocation && (
              <Field
                  ...
                  isLoading={this.state.eventLocationLoading}
                  data={
                      eventLocationOptions
                          ? shelfOptions.map(option => ({
                          value: option.id,
          ...
          {dateEvent && (
              <Field
                  name="dateEvent"
                  disabledDate={this.dateEvent}
                  component={renderDatePicker}
                  format={null}
                  isSearchable={false}
                  label={dateEvent.name[this.lng]}
                  formItemLayout={{
                      labelCol: {span: 10},
                      wrapperCol: {span: 14}
                  }}
