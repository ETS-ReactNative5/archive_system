...
class MainInfoCaseForm extends Component {
  ...
  externalFeaturesValue = {...this.props.initialValues.externalFeatures} || {kz: '', ru: '', en: ''};
  ...
  render() {
    ...
    const {
      ...
      tofiConstants: {
        fundNumber,
          formatAndBase,irreparablyDamaged,irreparablyDamagedTrue,caseInsuranceTrue,caseFundOfUseTrue,slide,compositionOfTextDocumentation,
        caseDbeg,
        caseDend,
        caseNumberOfPages,
        ...
        caseDocsLang,
          externalFeatures,
          photocast,positive,doubleNegative,movieNegative,shootPlace,documentShootAuthor,shootingDate,photoDescription,shelf,rack,caseStorage,caseFundOfUse,caseInsurance,caseDateOfDeposit,filmStrip
      }
    } = this.props;
        ...
        />
          ...
          {externalFeatures && (
              <Field
                  ...
                  component={renderInputLang}
                  format={value => (!!value ? value[lang.formatAndBase] : '')}
                  parse={value => { this.externalFeatures[lang.formatAndBase] = value; return {...this.externalFeaturesValue} }}
