            ...
            >
                ...
                {caseNotes && (
                    <Field
                        ...
                        parse={value => {
                            this.caseNotesValue[lang.caseNotes] = value;
                            return {...this.caseNotesValue}
                        }}
                ...
                {caseDocsLang && (
                    <Field
                        ...
                        data={caseDocLangObjOptions ? caseDocLangObjOptions.map(option => ({
                            value: option.id,
                ...
                {documentType && (
                    <Field
                        ...
                        isLoading={this.state.documentTypeLoading}
                        data={
                            documentTypefOptions
...
export default connect(state => {
    ...
    /*    rackOptions: state.generalData.rack,
        shelfOptions: state.generalData.shelfOptions*/
    }
}, {getObjChildsByConst, getPropVal,})(reduxForm({
