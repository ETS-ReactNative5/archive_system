...
class DamageWorks extends React.Component {
    ...
    render() {
        ...
        <div>
            ...
            <DamageTable stateRecord={this.props.stateRecord}
                         initialValues={this.props.initialValues}
                         header="Работы по устранению повреждений"
                         tofiConstants={this.props.tofiConstants} date={true}/>}
            <IrrDamageTable stateRecord={this.props.stateRecord}
                            initialValues={this.props.initialValues}
