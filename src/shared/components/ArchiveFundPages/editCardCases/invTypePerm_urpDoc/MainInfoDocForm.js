...
/*eslint eqeqeq:0*/
class MainInfoDocForm extends Component {
  constructor(props) {
    super(props);

    this.state = {
      lang: {
        documentAuthorValue: localStorage.getItem("i18nextLng"),
  ...
  documentAuthorValue = {...this.props.initialValues.documentAuthorValue} || {kz: '', ru: '', en: ''};
    ...
    return (
      ...
      >
        {documentCase && <Field
          ...
          label={documentCase.name[this.lng]}
          formItemLayout={{
            labelCol: {span: 10},
            wrapperCol: {span: 14}
          }}
        ...
        <Field
          ...
          format={value => (!!value ? value[lang.documentAuthor] : '')}
          parse={value => { this.documentAuthorValue[lang.documentAuthor] = value; return {...this.documentAuthorValue} }}
          label={t('NAME')}
...
const selector = formValueSelector('MainInfoDocForm');
...
}, {getObjChildsByConst, getPropVal, })(reduxForm({form: "MainInfoDocForm", enableReinitialize: true})(MainInfoDocForm));
