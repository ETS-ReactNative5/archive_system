...
class Table_invTypeVideo_videoDoc extends React.Component {

  render() {

    const { t, lng, tofiConstants: {fundNumber, fundIndex, caseDbeg, caseDend, caseNotes, caseStructuralSubdivision, dateForming,
      accountingUnitType, accountingUnitQuantity, nomenLastChangeDate, accountingUnitNumber, timingOfVideoRecording }
    } = this.props;
    return (
...
export default Table_invTypeVideo_videoDoc;