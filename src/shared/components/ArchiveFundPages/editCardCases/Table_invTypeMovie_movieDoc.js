...
class Table_invTypeMovie_movieDoc extends React.Component {

  render() {

    const { t, lng, tofiConstants: {fundNumber, fundIndex, caseDbeg, caseDend, caseNotes, caseStructuralSubdivision, dateForming,
      accountingUnitType, accountingUnitQuantity, nomenLastChangeDate, accountingUnitNumber, timingOfVideoRecording, playingTime }
    } = this.props;
    return (
...
export default Table_invTypeMovie_movieDoc;