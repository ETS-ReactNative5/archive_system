...
import {getCube, getPropVal,getIdGetObj, getObjByObjVal} from '../../actions/actions';
                        ...
                        <div className="Works__heading ">
                            <div className="table-header ">
                                ...
                                <div className="label-select">
                                    <Button type="primary" onClick={this.getFunmarker} disabled={this.state.selectedRow!== null ?false:true}> Фондообразователь</Button>
                                    <Button type="primary" onClick={this.getfundsList} disabled={this.state.selectedRow!== null?false:true} style={{marginLeft: 10}}> Фонд</Button>
                                </div>
