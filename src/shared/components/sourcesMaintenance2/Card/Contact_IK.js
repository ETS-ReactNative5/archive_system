...
class Contact_IK extends React.Component {
            ...
            filterDPAnd: [
                {
                    ...
                    conds: [
                        {
                            consts: "orgAddress,orgPhone,orgFax,orgEmail,website"
                        }
                    ]
                }
            ],
    ...
    renderTableData = (item, idx) => {
        const result = {};
        const constArr = ['orgAddress', 'orgPhone', 'orgFax', 'orgEmail', 'website'];
        parseForTable(item.props, this.props.tofiConstants, result, constArr);
        return result;
    };

    render() {
        return (<div><ContactForm initialValues={this.state.data[0]}
